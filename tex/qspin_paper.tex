...
\lstset{style=sublime,language=Python,inputpath=../scripts/}
%\lstset{style=sublime,language=Python}

% change default listings caption title
\renewcommand{\lstlistingname}{QuSpin \emph{Example Code}}% Listing -> \qspin\ Example Code
...
%\usepackage{upgreek}
%\newcommand{\spin}{$\mathcal{Q}^{\mathrm{u}}\!\mathcal{S}\mathcal{P}\mathcal{I}\mathcal{N}$}
