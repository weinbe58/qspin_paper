...
%
The time-periodic step drive can easily be incorporated through the following function\footnote{Here we explicitly put \texttt{omega} as an argument to our drive function. This would be useful if say one would like to drive with multiple frequencies without having to define multiple functions.}: 
