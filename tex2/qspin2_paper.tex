...
\begin{equation}
H(t)=H_{zz} -A\,\mathrm{sgn}\left(\cos(\Omega t)\right)H_x
\end{equation}
where $\Omega$ is the driving frequency, $T$ -- the corresponding period, and $A$ -- the driving amplitude. As the Hamiltonian obeys translation,parity and spin-inversion symmetries we will use this to speed up the evolution by working in the symmetry sector which contains the ground state. 

\cyan{need equation to show application of unitaries}
