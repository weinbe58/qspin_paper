...
\begin{itemize}
	...
	\item update and put python notebooks to doc
	\item update spinful fermion doc once ready
	\item update links to doc in appendix
	\item update github readme
	\item for manual install, list all required packages; update online doc	
